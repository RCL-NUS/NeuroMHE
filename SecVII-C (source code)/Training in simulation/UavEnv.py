...
class quadrotor:
    ...
    def ref_gazebo(self, Coeffx_gazebo, Coeffy_gazebo, Coeffz_gazebo, time, t_switch):
        if time <4+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_gazebo[0,:],time,t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_gazebo[0,:],time,t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_gazebo[0,:],time,t_switch)
        elif time >=4+t_switch and time <8+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_gazebo[1,:],time,4+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_gazebo[1,:],time,4+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_gazebo[1,:],time,4+t_switch)
        elif time >=8+t_switch and time <12+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_gazebo[2,:],time,8+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_gazebo[2,:],time,8+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_gazebo[2,:],time,8+t_switch)
        elif time >=12+t_switch and time <16+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_gazebo[3,:],time,12+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_gazebo[3,:],time,12+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_gazebo[3,:],time,12+t_switch)
        else:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_gazebo[4,:],time,16+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_gazebo[4,:],time,16+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_gazebo[4,:],time,16+t_switch)
    ...
    def ref_exp1(self, Coeffx_exp1, Coeffy_exp1, Coeffz_exp1, time, t_switch):
        if time <5+t_switch:
        ...
        elif time >=5+t_switch and time <11+t_switch:
            ...
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[2,:],time,11+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[2,:],time,11+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[2,:],time,11+t_switch)
        elif time >=13+t_switch and time <15+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[3,:],time,13+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[3,:],time,13+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[3,:],time,13+t_switch)
        elif time >=15+t_switch and time <21+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[4,:],time,15+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[4,:],time,15+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[4,:],time,15+t_switch)
        elif time >=21+t_switch and time <23+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[5,:],time,21+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[5,:],time,21+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[5,:],time,21+t_switch)
        elif time >=23+t_switch and time <25+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[6,:],time,23+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[6,:],time,23+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[6,:],time,23+t_switch)
        elif time >=25+t_switch and time <31+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[7,:],time,25+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[7,:],time,25+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[7,:],time,25+t_switch)
        elif time >=31+t_switch and time <33+t_switch:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[8,:],time,31+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[8,:],time,31+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[8,:],time,31+t_switch)
        elif time >=33+t_switch and time <35+t_switch: 
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[9,:],time,33+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[9,:],time,33+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[9,:],time,33+t_switch) 
        elif time >=35+t_switch and time <41+t_switch:  
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[10,:],time,35+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[10,:],time,35+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[10,:],time,35+t_switch)
        else:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[11,:],time,41+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[11,:],time,41+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[11,:],time,41+t_switch)
        ref_p = np.reshape(np.vstack((ref_px, ref_py, ref_pz)), (3,1))
        ref_v = np.reshape(np.vstack((ref_vx, ref_vy, ref_vz)), (3,1))
        ref_a = np.reshape(np.vstack((ref_ax, ref_ay, ref_az)), (3,1))
        ref_j = np.reshape(np.vstack((ref_jx, ref_jy, ref_jz)), (3,1))
    ...
    def ref_exp1_training(self, Coeffx_exp1, Coeffy_exp1, Coeffz_exp1, time, t_switch):
    ...
    def ref_exp1_fast(self, Coeffx_exp1, Coeffy_exp1, Coeffz_exp1, time, t_switch):
        if time <4+t_switch: # S->A
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[0,:],time,t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[0,:],time,t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[0,:],time,t_switch)
        elif time >=4+t_switch and time <7+t_switch: # A->A
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[1,:],time,4+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[1,:],time,4+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[1,:],time,4+t_switch)
        elif time >=7+t_switch and time <8.5+t_switch: # A->B
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[2,:],time,7+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[2,:],time,7+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[2,:],time,7+t_switch)
        elif time >=8.5+t_switch and time <10+t_switch: # B->C
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[3,:],time,8.5+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[3,:],time,8.5+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[3,:],time,8.5+t_switch)
        elif time >=10+t_switch and time <13+t_switch: # C->C
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[4,:],time,10+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[4,:],time,10+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[4,:],time,10+t_switch)
        elif time >=13+t_switch and time <14.5+t_switch: # C->D
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[5,:],time,13+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[5,:],time,13+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[5,:],time,13+t_switch)
        elif time >=14.5+t_switch and time <16+t_switch: # D->E
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[6,:],time,14.5+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[6,:],time,14.5+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[6,:],time,14.5+t_switch)
        elif time >=16+t_switch and time <19+t_switch: # E->E
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[7,:],time,16+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[7,:],time,16+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[7,:],time,16+t_switch)
        elif time >=19+t_switch and time <20.5+t_switch: # E->B
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[8,:],time,19+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[8,:],time,19+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[8,:],time,19+t_switch)
        elif time >=20.5+t_switch and time <22+t_switch: # B->F
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[9,:],time,20.5+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[9,:],time,20.5+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[9,:],time,20.5+t_switch) 
        elif time >=22+t_switch and time <25+t_switch: # F->F
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[10,:],time,22+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[10,:],time,22+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[10,:],time,22+t_switch)
        else:
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp1[11,:],time,25+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp1[11,:],time,25+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp1[11,:],time,25+t_switch)
        ref_p = np.reshape(np.vstack((ref_px, ref_py, ref_pz)), (3,1))
        ref_v = np.reshape(np.vstack((ref_vx, ref_vy, ref_vz)), (3,1))
        ref_a = np.reshape(np.vstack((ref_ax, ref_ay, ref_az)), (3,1))
        ref_j = np.reshape(np.vstack((ref_jx, ref_jy, ref_jz)), (3,1))
    ...
    def ref_exp2(self, Coeffx_exp2, Coeffy_exp2, Coeffz_exp2, time, t_switch):
        if time <4+t_switch:
        ...
        elif time >=4+t_switch and time <14+t_switch:
            ...
            ref_px, ref_vx, ref_ax, ref_jx, ref_sx = self.polytraj(Coeffx_exp2[2,:],time,14+t_switch)
            ref_py, ref_vy, ref_ay, ref_jy, ref_sy = self.polytraj(Coeffy_exp2[2,:],time,14+t_switch)
            ref_pz, ref_vz, ref_az, ref_jz, ref_sz = self.polytraj(Coeffz_exp2[2,:],time,14+t_switch)
