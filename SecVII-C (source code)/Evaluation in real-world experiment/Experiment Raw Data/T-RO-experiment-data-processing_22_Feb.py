...
if experiment == 'a':
    ...
    if controller == 'a':
        ...
        plt.figure(2,figsize=(6/cm_2_inch,6*0.7/cm_2_inch),dpi=600)
        ...
        # leg.get_frame().set_linewidth(0.5)
        ax.set_xlabel('x [m]',labelpad=-12,**font1)
        ax.set_ylabel('y [m]',labelpad=-12,**font1)
        ...
        ax.tick_params(axis='z',which='major',pad=-3,length=1)
        ax.set_yticks([-1,0,1])
        ...
        plt.savefig('NeuroMHE/tracking_NeuroMHE.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        rmse_p  = format(mean_squared_error(ref_enu[3,:], position_enu[3,:],squared=False),'.3f')# scalar-error
        ...
        rmse_f  = format(mean_squared_error(Gt_lpf[3,:], Df_Imhe_enu[3,n_start:len(g_r_dmhe)], squared=False),'.3f') # scalar-error
        ...
        ax3.set_ylabel('$d_{z}$ [N]',labelpad=0,**font1)
        ax3.set_xlabel('Time [s]',labelpad=0,**font1) # -4 for 8
        ...
        for t in ax3.yaxis.get_major_ticks(): 
            t.label.set_font('arial') 
            t.label.set_fontsize(6)
        leg=ax1.legend(['Ground truth', 'Estimation', 'Tension force'],loc='upper center',prop=font1, bbox_to_anchor=(0.49, 1.4),labelspacing=0.15,ncol = 3,columnspacing=0.5,borderpad=0.3,handletextpad=0.3,handlelength=1.2)
        leg.get_frame().set_linewidth(0.5)
        ax1.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
        ax2.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
        ax3.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
        ...
        for axis in ['top', 'bottom', 'left', 'right']:
            ax3.spines[axis].set_linewidth(0.5)
        plt.savefig('NeuroMHE/force_NeuroMHE_h.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        ax.yaxis._axinfo["grid"].update({"linewidth":0.5,"linestyle":'--'})
        ax.zaxis._axinfo["grid"].update({"linewidth":0.5,"linestyle":'--'})
        plt.savefig('DMHE/tracking_DMHE.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        for axis in ['top', 'bottom', 'left', 'right']:
            ax3.spines[axis].set_linewidth(0.5)
        plt.savefig('DMHE/force_DMHE_h.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        ax.yaxis._axinfo["grid"].update({"linewidth":0.5,"linestyle":'--'})
        ax.zaxis._axinfo["grid"].update({"linewidth":0.5,"linestyle":'--'})
        plt.savefig('L1-AC/tracking_L1AC.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        for axis in ['top', 'bottom', 'left', 'right']:
            ax3.spines[axis].set_linewidth(0.5)
        plt.savefig('L1-AC/force_L1AC_h.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
    ...
    #     plt.show()
        ...
        plt.figure(1,figsize=(6/cm_2_inch,6*0.7/cm_2_inch),dpi=600)
        ax = plt.axes(projection="3d")
        ax.plot3D(ref_enu[0,:], ref_enu[1,:], ref_enu[2,:], linewidth=1.5, linestyle='--',color='black')
        ax.plot3D(position_enu[0,:], position_enu[1,:], position_enu[2,:], linewidth=1,color='orange')
        ax.plot3D(position_enu_lg[0,:], position_enu_lg[1,:], position_enu_lg[2,:], linewidth=1,color='blue')
        leg=plt.legend(['EQ: Ref.',r'EQ: $1\times$gain',r'EQ: $4\times$gain'],loc='upper center',prop=font1, bbox_to_anchor=(0.475, 1.05),labelspacing=0.15,ncol = 2,columnspacing=0.4,borderpad=0.3,handletextpad=0.3,handlelength=1.5)
        leg.get_frame().set_linewidth(0.5)
        ax.set_xlabel('x [m]',labelpad=-12,**font1)
        ax.set_ylabel('y [m]',labelpad=-12,**font1)
        ax.set_zlabel('z [m]',labelpad=-10,**font1)
        ...
        ax.yaxis._axinfo["grid"].update({"linewidth":0.5,"linestyle":'--'})
        ax.zaxis._axinfo["grid"].update({"linewidth":0.5,"linestyle":'--'})
        plt.savefig('Baseline_same_gain/tracking_baseline.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
    ...
    if controller == 'a':
        ...
        des_est_xy = np.zeros((1,n_dw_end-n_dw_start))
        error_xy   = np.zeros((1,n_dw_end-n_dw_start))
        for k in range(n_dw_end-n_dw_start):
            error_xy[:,k:k+1]=LA.norm(Gt_lpf[0:2,k]-Df_Imhe_enu[0:2,k])
            
        

        print('mean horizontal force=',format(np.mean(Gt_lpf[3,:]),'.3f'))
        print('mean horizontal force (downwash)=',format(mean_squared_error(Gt_lpf[3,n_dw_start:n_dw_end],np.zeros(n_dw_end-n_dw_start)),'.3f'))
        ...
        rmse_fxy = format(mean_squared_error(error_xy, des_est_xy, squared=False),'.3f')
        ...
        ax1.plot(Time,Gt_lpf[3,:], linewidth=0.5,zorder=4,color='black')
        ax1.plot(Time,Df_Imhe_enu[3,:], linewidth=0.5,zorder=8,color='orange')
        ax1.set_xticks(np.arange(0,25,8))
        ax1.tick_params(axis='x',which='major',pad=0,length=1)
        ax1.tick_params(axis='y',which='major',pad=0,length=1)
        ax1.set_ylabel('$d_{xy}$ [N]',labelpad=0,**font1) 
        ...
        ax1.add_patch(Rectangle((17, 0), 2, 1.8,
             ...
             alpha = 0.2,
             lw=0.1))
        leg=ax1.legend(['Ground truth', 'Estimation'],loc='upper center',prop=font1, bbox_to_anchor=(0.5, 1.35),labelspacing=0.15,ncol = 2,columnspacing=0.4,borderpad=0.3,handletextpad=0.3,handlelength=1.5)
        leg.get_frame().set_linewidth(0.5)
        ax2.plot(Time,Gt_lpf[2,:], linewidth=0.5,zorder=4,color='black')
        ax2.plot(Time,Df_Imhe_enu[2,:], linewidth=0.5,zorder=8,color='orange')
        ...
        for axis in ['top', 'bottom', 'left', 'right']:
            ax2.spines[axis].set_linewidth(0.5)
        plt.savefig('NeuroMHE_downwash/force_NeuroMHE_downwash_h.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()


        fig, (ax1,ax2) = plt.subplots(2,sharex=True,figsize=(4.25/cm_2_inch,4.25*0.7/cm_2_inch),dpi=600)
        ax1.plot(Time,position_enu[3,:], linewidth=0.5,zorder=8,color='orange')
        ax1.set_xticks(np.arange(0,25,8))
        ax1.tick_params(axis='x',which='major',pad=0,length=1)
        ax1.tick_params(axis='y',which='major',pad=0,length=1)
        ax1.set_ylabel('$p_{xy}$ [m]',labelpad=0,**font1)
        ...
        ax1.add_patch(Rectangle((17, 0), 2, 0.4,
             ...
             alpha = 0.2,
             lw=0.1))
        ax2.plot(Time,ref_enu[2,:], linewidth=0.5,zorder=4,color='black')
        ax2.plot(Time,position_enu[2,:], linewidth=0.5,zorder=8,color='orange')
        ax2.plot(Time,pos_big_enu[2,(600):(n_end+600)], linewidth=0.5,zorder=4,color='green')
        ax2.set_xticks(np.arange(0,25,8))
        ax2.tick_params(axis='x',which='major',pad=0,length=1)
        ax2.tick_params(axis='y',which='major',pad=0,length=1)
        ax2.set_xlabel('Time [s]',labelpad=0,**font1)
        ax2.set_ylabel('$p_{z}$ [m]',labelpad=0,**font1)
        ...
        for axis in ['top', 'bottom', 'left', 'right']:
            ax2.spines[axis].set_linewidth(0.5)
        plt.savefig('NeuroMHE_downwash/position_NeuroMHE_downwash.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        for axis in ['top', 'bottom', 'left', 'right']:
            ax2.spines[axis].set_linewidth(0.5)
        plt.savefig('DMHE_downwash/force_DMHE_downwash_h.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        plt.savefig('DMHE_downwash/position_DMHE_downwash.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        for k in range(n_start,n_start+n_end,1):
            ...
            # quaternion = np.array([q0, q1, q2, q3])
            # R_b        = Quaternion2Rotation(quaternion)
            # dfmhe_enu = np.matmul(R_b,dfmhe_enu)
            Df_Imhe_enu[0:3,i:i+1] = dfmhe_enu
            Df_Imhe_enu[3,i:i+1]   = LA.norm(dfmhe_enu[0:2,0])
            Df_Imhe_enu[4,i:i+1]   = LA.norm(dfmhe_enu)
            i += 1
        ...
        n_dw_start = int(7.25*sample_rate) # the time when the downwash takes effect, including the post downwash effect
        n_dw_steady = int(13*sample_rate)
        n_dw_end   = int(16.25*sample_rate)
        ...
        for axis in ['top', 'bottom', 'left', 'right']:
            ax2.spines[axis].set_linewidth(0.5)
        plt.savefig('L1-AC_downwash/force_L1AC_downwash_h.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        plt.savefig('L1-AC_downwash/position_L1AC_downwash.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
        ...
        dataset={'a':"Baseline_samegain_downwash/log_7_2023-2-21-17-49-36_vehicle_local_position_0.csv",
            ...
            #  'd':"Baseline_samegain_downwash/log_7_2023-2-21-17-49-36_position_setpoint_triplet_0.csv",
             'e':"Baseline_largergain_downwash/log_9_2023-2-21-17-54-40_sensor_combined_0.csv",
            #  'e':"Baseline_samegain_downwash/log_7_2023-2-21-17-49-36_sensor_combined_0.csv",
             'f':"Baseline_largergain_downwash/log_9_2023-2-21-17-54-40_vehicle_attitude_0.csv"
            #  'f':"Baseline_samegain_downwash/log_7_2023-2-21-17-49-36_vehicle_attitude_0.csv"
             }
        local_position = pd.read_csv(dataset['a'])
        local_position_lg = pd.read_csv(dataset['b'])
        ...
        print('mean horizontal force=',format(np.mean(Gt_lpf[3,:]),'.3f'))
        # print('mean horizontal force (downwash)=',format(mean_squared_error(Gt_lpf[3,n_dw_start:n_dw_end],np.zeros(n_dw_end-n_dw_start)),'.3f'))
        print('mean horizontal force (downwash)=',format(np.mean(Gt_lpf[3,n_dw_start:n_dw_end]),'.3f'))
        rmse_pxy = format(mean_squared_error(ref_enu[3,n_dw_start:n_dw_end], position_enu[3,n_dw_start:n_dw_end], squared=False),'.3f')
        est_pz  = format(mean_squared_error(ref_enu[2,n_dw_steady:n_dw_end], position_enu[2,n_dw_steady:n_dw_end], squared=False),'.3f')
        # rmse_p   = format(mean_squared_error(ref_enu[4,n_dw_start:n_dw_end], position_enu[4,n_dw_start:n_dw_end], squared=False),'.3f')
        ...
        # for axis in ['top', 'bottom', 'left', 'right']:
        #     ax2.spines[axis].set_linewidth(0.5)
        # plt.savefig('Baseline_samegain_downwash/force_baseline_samegain_downwash_h.png')
        # plt.show()


        fig, (ax1,ax2) = plt.subplots(2,sharex=True,figsize=(4.25/cm_2_inch,4.25*0.7/cm_2_inch),dpi=600)
        ax1.plot(Time,position_enu[3,:],linewidth=0.5,zorder=4,color='orange')
        ax1.plot(Time,position_enu_lg[3,:],linewidth=0.5,zorder=4,color='blue')
        ax1.set_xticks(np.arange(0,25,8))
        ax1.tick_params(axis='x',which='major',pad=0,length=1)
        ax1.tick_params(axis='y',which='major',pad=0,length=1)
        ax1.set_ylabel('$p_{xy}$ [m]',labelpad=0,**font1)
        ...
        ax1.add_patch(Rectangle((17.5, 0), 2, 0.4,
             ...
             lw=0.1))
        ax2.plot(Time,ref_enu[2,:], linewidth=0.5,zorder=4,color='black')
        ax2.plot(Time,position_enu[2,:], linewidth=0.5,zorder=4,color='orange')
        ax2.plot(Time,position_enu_lg[2,:],linewidth=0.5,zorder=4,color='blue')
        ...
        ax2.add_patch(Rectangle((17.5, 0), 2, 2.2,
             ...
             alpha = 0.2,
             lw=0.1))
        leg=ax2.legend(['EQ: Ref.', r'EQ: $1\times$ gain', r'EQ: $3\times$ gain', '2nd Quad.'],loc='upper center',prop=font1, bbox_to_anchor=(0.47, 2.85),labelspacing=0.15,ncol = 2,columnspacing=0.4,borderpad=0.3,handletextpad=0.3,handlelength=1.5)
        leg.get_frame().set_linewidth(0.5)
        for t in ax1.yaxis.get_major_ticks(): 
            t.label.set_font('arial') 
            t.label.set_fontsize(6)
        ...
        for axis in ['top', 'bottom', 'left', 'right']:
            ax2.spines[axis].set_linewidth(0.5)
        plt.savefig('Baseline_samegain_downwash/comparison_baseline_downwash.png',bbox_inches="tight", pad_inches=0.01, dpi=600)
        plt.show()
