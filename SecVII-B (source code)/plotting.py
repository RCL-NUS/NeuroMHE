...
df_MH_dmhe_test = np.load('evaluation_results/test_dmhe_evaluation/df_MH_dmhe.npy')
colnum = np.size(df_MH_dmhe_test,1)
df_MH_dmhe_xy_test = np.zeros((1,colnum))
for k in range(colnum):
    df_MH_dmhe_xy_test[:,k]=LA.norm(df_MH_dmhe_test[0:2,k])
...
dtau_MH_dmhe_test = np.load('evaluation_results/test_dmhe_evaluation/dtau_MH_dmhe.npy')
...
p_gt_dmhe_test= np.load('evaluation_results/test_dmhe_evaluation/p_gt_dmhe.npy')
...
# plt.plot(p_gt_dmhe_test[1,:], -p_gt_dmhe_test[0,:], linewidth=1)
...
# plt.plot(Time_e, p_gt_dmhe_test[2,:]-ref_z_e, linewidth=1,color='red')
...
# plt.plot(Time_e, df_MH_dmhe_xy_test[0,:], linewidth=0.5,color='red')
...
# plt.plot(Time_e, df_MH_dmhe_test[2,:], linewidth=0.5,color='red')
