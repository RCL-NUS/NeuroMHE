...
rmse_fxy_neuromhe = np.load('RMSE_boxplot_data/Rmse_fxy_neuromhe.npy')
rmse_fz_neuromhe  = np.load('RMSE_boxplot_data/Rmse_fz_neuromhe.npy')
rmse_txy_neuromhe = np.load('RMSE_boxplot_data/Rmse_txy_neuromhe.npy')
rmse_tz_neuromhe  = np.load('RMSE_boxplot_data/Rmse_tz_neuromhe.npy')
rmse_pxy_neuromhe = np.load('RMSE_boxplot_data/Rmse_pxy_neuromhe.npy')
rmse_pz_neuromhe  = np.load('RMSE_boxplot_data/Rmse_pz_neuromhe.npy')
rmse_fxy_dmhe = np.load('RMSE_boxplot_data/Rmse_fxy_dmhe.npy')
rmse_fz_dmhe  = np.load('RMSE_boxplot_data/Rmse_fz_dmhe.npy')
rmse_txy_dmhe = np.load('RMSE_boxplot_data/Rmse_txy_dmhe.npy')
rmse_tz_dmhe  = np.load('RMSE_boxplot_data/Rmse_tz_dmhe.npy')
rmse_pxy_dmhe = np.load('RMSE_boxplot_data/Rmse_pxy_dmhe.npy')
rmse_pz_dmhe  = np.load('RMSE_boxplot_data/Rmse_pz_dmhe.npy')
rmse_fxy_l1 = np.load('RMSE_boxplot_data/Rmse_fxy_l1.npy')
rmse_fz_l1  = np.load('RMSE_boxplot_data/Rmse_fz_l1.npy')
rmse_txy_l1 = np.load('RMSE_boxplot_data/Rmse_txy_l1.npy')
rmse_tz_l1  = np.load('RMSE_boxplot_data/Rmse_tz_l1.npy')
rmse_pxy_l1 = np.load('RMSE_boxplot_data/Rmse_pxy_l1.npy')
rmse_pz_l1  = np.load('RMSE_boxplot_data/Rmse_pz_l1.npy')
rmse_fxy_l1active = np.load('RMSE_boxplot_data/Rmse_fxy_l1active.npy')
rmse_fz_l1active  = np.load('RMSE_boxplot_data/Rmse_fz_l1active.npy')
rmse_txy_l1active = np.load('RMSE_boxplot_data/Rmse_txy_l1active.npy')
rmse_tz_l1active  = np.load('RMSE_boxplot_data/Rmse_tz_l1active.npy')
rmse_pxy_l1active = np.load('RMSE_boxplot_data/Rmse_pxy_l1active.npy')
rmse_pz_l1active  = np.load('RMSE_boxplot_data/Rmse_pz_l1active.npy')
...
# plt.figure(1, figsize=(9/cm_2_inch,9*0.8/cm_2_inch),dpi=600)
...
# ax.view_init(15,-160)
# plt.savefig('plots_in_paper/3d_trajectory.png')
# plt.show()
...
plt.savefig('plots_in_paper/training_meanloss.png')
plt.show()
...
# plt.xlabel('Time [s]', labelpad=-5.5, **font1)
...
# plt.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
# plt.savefig('plots_in_paper/force_xy_training_neuromhe.png')
# plt.show()

# plt.figure(5, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
...
# plt.xlabel('Time [s]', labelpad=-5.5, **font1)
# plt.xticks(np.arange(0,16,5),**font1)
# plt.ylabel('$d_{f_{z}}$ [N]', labelpad=-3, **font1)
# plt.yticks(np.arange(-24,1,8),**font1)
# mpl.rcParams['patch.linewidth']=0.5
# # leg=plt.legend(['Ground truth', 'Untrained','Trained: 1st episode','Trained: 2nd episode'],prop=font1,loc=(0.05,0.05),labelspacing=0.1)
# # leg.get_frame().set_linewidth(0.5)
# ax.tick_params(axis='x',which='major',pad=-1)
# ax.tick_params(axis='y',which='major',pad=-1)
# for axis in ['top', 'bottom', 'left', 'right']:
#     ax.spines[axis].set_linewidth(0.5)
# plt.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
# plt.savefig('plots_in_paper/force_z_training_neuromhe.png')
# plt.show()

# plt.figure(6, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
...
# plt.xlabel('Time [s]', labelpad=-5.5, **font1)
# plt.xticks(np.arange(0,16,5),**font1)
# plt.ylabel('$d_{\\tau_{xy}}$ [Nm]', labelpad=-1.5, **font1)
...
# plt.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
# plt.savefig('plots_in_paper/torque_xy_training_neuromhe.png')
# plt.show()

# plt.figure(7, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
...
# plt.xlabel('Time [s]', labelpad=-5.5, **font1)
# plt.xticks(np.arange(0,16,5),**font1)
# plt.ylabel('$d_{\\tau_{z}}$ [Nm]', labelpad=-4.5, **font1)
...
# ax.yaxis.get_offset_text().set_fontsize(6)
# plt.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
# plt.savefig('plots_in_paper/torque_z_training_neuromhe.png')
# plt.show()


# inverse of noise covariance
# plt.figure(8, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
# plt.plot(Time, inverse_fx**2, linewidth=0.5)
# plt.plot(Time, inverse_fy**2, linewidth=0.5)
# plt.plot(Time, inverse_fz**2, linewidth=0.5)
# plt.xlabel('Time [s]', labelpad=-6, **font1)
# plt.xticks(np.arange(0,16,5),**font1)
# plt.ylabel('Inverse of covariance',labelpad=-1, **font1)
# plt.yticks(np.arange(0,1.1,0.5),**font1)
# mpl.rcParams['patch.linewidth']=0.5
# leg=ax.legend(['$\sigma^{-2}_{f_x}$', '$\sigma^{-2}_{f_y}$','$\sigma^{-2}_{f_z}$'],loc='upper center',prop=font1)
# leg.get_frame().set_linewidth(0.5)
...
# # ax.yaxis.set_major_formatter(OOMFormatter(-2,"%1.1f"))
# plt.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
# plt.savefig('plots_in_paper/inverse_force.png')
# plt.show()
...
# # ax.yaxis.set_major_formatter(OOMFormatter(-2,"%1.1f"))
# plt.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
# plt.savefig('plots_in_paper/inverse_force_evaluation.png')
# plt.show()

# forgetting factor
# plt.figure(9, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
# plt.plot(Time, weight_para[24,:], linewidth=0.5)
# plt.xlabel('Time [s]', labelpad=-6, **font1)
# plt.xticks(np.arange(0,16,5),**font1)
# plt.ylabel('Forgetting factor $\gamma_1$',labelpad=-1, **font1)
...
# # ax.yaxis.set_major_formatter(OOMFormatter(-2,"%1.1f"))
# # ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/gamma1_fig.png')
# plt.show()
...
# # ax.yaxis.set_major_formatter(OOMFormatter(-2,"%1.1f"))
# # ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/gamma1_fig_evaluation.png')
# plt.show()

# plt.figure(10, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
# plt.plot(Time, weight_para[42,:], linewidth=0.5)
# plt.xlabel('Time [s]', labelpad=-6, **font1)
# plt.xticks(np.arange(0,16,5),**font1)
# plt.ylabel('Forgetting factor $\gamma_2$',labelpad=-1, **font1)
...
# # ax.yaxis.set_major_formatter(OOMFormatter(-2,"%1.1f"))
# # ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/gamma2_fig.png')
# plt.show()
...
# # ax.yaxis.set_major_formatter(OOMFormatter(-2,"%1.1f"))
# # ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/gamma2_fig_evaluation.png')
# plt.show()

# plt.figure(11, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
# plt.plot(Time, Q_k[0,:], linewidth=0.5)
# plt.plot(Time, Q_k[1,:], linewidth=0.5)
# plt.plot(Time, Q_k[2,:], linewidth=0.5)
# plt.xlabel('Time [s]', labelpad=-6, **font1)
# plt.xticks(np.arange(0,16,5),**font1)
# plt.ylabel('Discounted $Q_{t-1}$',labelpad=-1, **font1)
# plt.yticks(np.arange(0,0.12,0.05),**font1)
# mpl.rcParams['patch.linewidth']=0.5
# leg=ax.legend(['$\gamma_2 q_1$', '$\gamma_2 q_2$','$\gamma_2 q_3$'],loc='upper center',prop=font1)
# leg.get_frame().set_linewidth(0.5)
# ax.tick_params(axis='x',which='major',pad=-0.25)
# ax.tick_params(axis='y',which='major',pad=-1)
# for axis in ['top', 'bottom', 'left', 'right']:
...
# ax.yaxis.set_major_formatter(OOMFormatter(-1,"%1.1f"))
# ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/discountedQ_force.png')
# plt.show()
...
# ax.yaxis.set_major_formatter(OOMFormatter(-1,"%1.1f"))
# ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/discountedQ_force_evaluation.png')
# plt.show()

# plt.figure(12, figsize=(8/cm_2_inch,8*0.7/cm_2_inch), dpi=600)
# ax = plt.gca()
# plt.plot(ref_y_e,-ref_x_e,  linewidth=3,color='black')
# plt.plot(p_gt_neuromhe[1,:], -p_gt_neuromhe[0,:], linewidth=1.5,color='orange')
# plt.plot(p_gt_dmhe[1,:], -p_gt_dmhe[0,:], linewidth=1)
# plt.plot(p_gt_l1[1,:], -p_gt_l1[0,:], linewidth=0.5,linestyle='--')
# plt.plot(p_gt_l1_active[1,:], -p_gt_l1_active[0,:], linewidth=0.5,linestyle='--')
# plt.plot(p_gt_baseline[1,:], -p_gt_baseline[0,:], linewidth=0.5)
...
# leg=ax.legend(['Desired', 'NeuroMHE','DMHE','$\mathcal{L}_1$-AC','Active $\mathcal{L}_1$-AC','Baseline'],loc='upper left',prop=font1)
# leg.get_frame().set_linewidth(0.5)
# ax.tick_params(axis='x',which='major',pad=0)
# ax.tick_params(axis='y',which='major',pad=0)
# for axis in ['top', 'bottom', 'left', 'right']:
#     ax.spines[axis].set_linewidth(0.5)
# plt.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
# plt.savefig('plots_in_paper/planar_evaluation.png')
# plt.show()

# plt.figure(13, figsize=(8/cm_2_inch,8*0.45/cm_2_inch), dpi=600)
# ax = plt.gca()
# # plt.plot(Time_e, ref_z_e,  linewidth=3,color='black')
# plt.plot(Time_e, p_gt_neuromhe[2,:]-ref_z_e, linewidth=1,color='orange')
# plt.plot(Time_e, p_gt_dmhe[2,:]-ref_z_e, linewidth=1,color='blue')
...
# plt.xlabel('Time [s]', labelpad=-4.5, **font1)
...
# # ax.yaxis.get_offset_text().set_fontsize(6)
# plt.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
# plt.savefig('plots_in_paper/z_evaluation.png')
# plt.show()

# plot the quadrotor state estimation against the ground truth state
# fig, (ax1,ax2,ax3) = plt.subplots(3,sharex=True,figsize=(4.5/cm_2_inch,5.5/cm_2_inch),dpi=600)
...
# ax1.set_ylabel('$p_{x}$ [m]',labelpad=-1,**font1)
# ax2.set_ylabel('$p_{y}$ [m]',labelpad=-2.5,**font1)
# ax3.set_ylabel('$p_{z}$ [m]',labelpad=2.5,**font1)
...
#     t.label.set_font('Times New Roman') 
#     t.label.set_fontsize(7)
# leg=ax2.legend(['Ground truth', 'Estimation'],loc='lower left',prop=font1,labelspacing=0.1)
# leg.get_frame().set_linewidth(0.5)
...
# plt.savefig('plots_in_paper/position_neuromhe.png')
# plt.show()
...
# ax1.set_ylabel('$v_{x}$ [m/s]',labelpad=-1.5,**font1)
# ax2.set_ylabel('$v_{y}$ [m/s]',labelpad=-1.5,**font1)
# ax3.set_ylabel('$v_{z}$ [m/s]',labelpad=-1.5,**font1)
# ax3.set_xlabel('Time [s]',labelpad=0,**font1)
# for t in ax1.yaxis.get_major_ticks(): 
#     t.label.set_font('Times New Roman') 
#     t.label.set_fontsize(7)
...
# for axis in ['top', 'bottom', 'left', 'right']:
#     ax3.spines[axis].set_linewidth(0.5)
# plt.savefig('plots_in_paper/velocity_neuromhe.png')
# plt.show()
...
# ax3.yaxis.get_offset_text().set_fontsize(5.5)
# ax3.yaxis.get_offset_text().set_verticalalignment('center')
# ax3.set_xticks(np.arange(0,16,5))
# ax1.set_ylabel('Roll [rad]',labelpad=-5,**font1)
# ax2.set_ylabel('Pitch [rad]',labelpad=-1.5,**font1)
# ax3.set_ylabel('Yaw [rad]',labelpad=-1.5,**font1)
# ax3.set_xlabel('Time [s]',labelpad=0,**font1)
# for t in ax1.yaxis.get_major_ticks(): 
#     t.label.set_font('Times New Roman') 
#     t.label.set_fontsize(7)
...
# for axis in ['top', 'bottom', 'left', 'right']:
#     ax3.spines[axis].set_linewidth(0.5)
# plt.savefig('plots_in_paper/euler_neuromhe.png')
# plt.show()
...
# ax3.set_xticks(np.arange(0,16,5))
# ax1.set_ylabel('$\omega_{x}$ [rad/s]',labelpad=-2,**font1)
# ax2.set_ylabel('$\omega_{y}$ [rad/s]',labelpad=-2.5,**font1)
# ax3.set_ylabel('$\omega_{z}$ [rad/s]',labelpad=-6,**font1)
# ax3.set_xlabel('Time [s]',labelpad=0,**font1)
# for t in ax1.yaxis.get_major_ticks(): 
#     t.label.set_font('Times New Roman') 
#     t.label.set_fontsize(7)
...
# for axis in ['top', 'bottom', 'left', 'right']:
#     ax3.spines[axis].set_linewidth(0.5)
# plt.savefig('plots_in_paper/angular_rate_neuromhe.png')
# plt.show()

# plt.figure(14, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
...
# plt.xlabel('Time [s]', labelpad=-6, **font1)
# plt.xticks(np.arange(0,11,3.5),**font1)
# plt.ylabel('$d_{f_{xy}}$ [N]',labelpad=-1, **font1)
# plt.yticks(np.arange(0,16,5),**font1)
# mpl.rcParams['patch.linewidth']=0.5
# leg=ax.legend(['Ground truth', 'NeuroMHE','DMHE','$\mathcal{L}_1$-AC','Active $\mathcal{L}_1$-AC'],loc='lower center',prop=font1,labelspacing=0.1)
# leg.get_frame().set_linewidth(0.5)
# ax.tick_params(axis='x',which='major',pad=-0.25)
# ax.tick_params(axis='y',which='major',pad=-1)
# for axis in ['top', 'bottom', 'left', 'right']:
...
# # ax.yaxis.set_major_formatter(OOMFormatter(-2,"%1.1f"))
# # ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/force_xy_evaluation.png')
# plt.show()

# plt.figure(15, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
...
# # ax.yaxis.set_major_formatter(OOMFormatter(-2,"%1.1f"))
# # ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/force_z_evaluation.png')
# plt.show()
...
# ax.yaxis.set_major_formatter(OOMFormatter(-1,"%1.1f"))
# ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/torque_xy_evaluation.png')
# plt.show()


# plt.figure(16, figsize=(5/cm_2_inch,5*0.65/cm_2_inch), dpi=600)
# ax = plt.gca()
...
# ax.yaxis.set_major_formatter(OOMFormatter(-1,"%1.1f"))
# ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/torque_z_evaluation.png')
# plt.show()
...
# plt.figure(17, figsize=(8/cm_2_inch,8*0.475/cm_2_inch), dpi=600)
# ax = plt.gca()
...
# plt.yticks(np.arange(0.5,3.1,1),**font1)
...
#     ax.spines[axis].set_linewidth(0.5)
# plt.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
# plt.savefig('plots_in_paper/force_rmse_comparsion.png')
# plt.show()


# plt.figure(18, figsize=(8/cm_2_inch,8*0.475/cm_2_inch), dpi=600)
# ax = plt.gca()
# # Get the max of the dataset
...
#     positions = [x_pos[i] + j * 1 for j in range(len(data.T))]
#     bp = plt.boxplot(
#         np.array(data), sym='', whis=[0, 100], widths=0.6 / len(datasets_t),
...
# ax.yaxis.set_major_formatter(OOMFormatter(-1,"%1.1f"))
# ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/torque_rmse_comparsion.png')
# plt.show()



# plt.figure(19, figsize=(8/cm_2_inch,8*0.475/cm_2_inch), dpi=600)
# ax = plt.gca()
# # Get the max of the dataset
...
#     positions = [x_pos[i] + j * 1 for j in range(len(data.T))]
#     bp = plt.boxplot(
#         np.array(data), sym='', whis=[0, 100], widths=0.6 / len(datasets_p),
...
# plt.yticks(np.arange(0,0.22,0.07),**font1)
# ax.xaxis.set_minor_locator(matplotlib.ticker.FixedLocator(
...
# ax.yaxis.set_major_formatter(OOMFormatter(-1,"%1.1f"))
# ax.yaxis.get_offset_text().set_fontsize(6)
# plt.savefig('plots_in_paper/position_rmse_comparsion.png')
# plt.show()
