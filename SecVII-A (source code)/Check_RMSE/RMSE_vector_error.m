%MATLAB code for re-producing the RMSE results (the same network model as used in our previous manuscript but with the appropriate metrics)
clear
...
filename=['evaluation_vector_error/disest_mhe_',key,'.csv'];
