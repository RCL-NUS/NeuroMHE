...
Gt_fx = np.load('evaluation_vector_error/Gt_fx_'+str(key)+'.npy')
Gt_fy = np.load('evaluation_vector_error/Gt_fy_'+str(key)+'.npy')
Gt_fz = np.load('evaluation_vector_error/Gt_fz_'+str(key)+'.npy')
Gt_tx = np.load('evaluation_vector_error/Gt_tx_'+str(key)+'.npy')
Gt_ty = np.load('evaluation_vector_error/Gt_ty_'+str(key)+'.npy')
Gt_tz = np.load('evaluation_vector_error/Gt_tz_'+str(key)+'.npy')
Gt_fxy = np.load('evaluation_vector_error/Gt_fxy_'+str(key)+'.npy') # 2-norm of [Gt_fx, Gt_fy] for scalar error
Gt_f   = np.load('evaluation_vector_error/Gt_f_'+str(key)+'.npy') # 2-norm of [Gt_fx, Gt_fy, Gt_fz] for scalar error
Gt_txy = np.load('evaluation_vector_error/Gt_txy_'+str(key)+'.npy') # 2-norm of [Gt_tx, Gt_ty] for scalar error
Gt_t   = np.load('evaluation_vector_error/Gt_t_'+str(key)+'.npy') # 2-norm of [Gt_tx, Gt_ty, Gt_tz] for scalar error

#---load the NeuroBEM prediction data (copied from the open-source dataset)---#
Bemnn_fx  = np.load('evaluation_vector_error/Bemnn_fx_'+str(key)+'.npy')
Bemnn_fy  = np.load('evaluation_vector_error/Bemnn_fy_'+str(key)+'.npy')
Bemnn_fz  = np.load('evaluation_vector_error/Bemnn_fz_'+str(key)+'.npy')
Bemnn_tx  = np.load('evaluation_vector_error/Bemnn_tx_'+str(key)+'.npy')
Bemnn_ty  = np.load('evaluation_vector_error/Bemnn_ty_'+str(key)+'.npy')
Bemnn_tz  = np.load('evaluation_vector_error/Bemnn_tz_'+str(key)+'.npy')
Bemnn_fxy = np.load('evaluation_vector_error/Bemnn_fxy_'+str(key)+'.npy') # 2-norm of [Bemnn_fx, Bemnn_fy] for scalar error
Bemnn_f   = np.load('evaluation_vector_error/Bemnn_f_'+str(key)+'.npy') # 2-norm of [Bemnn_fx, Bemnn_fy, Bemnn_fz] for scalar error
Bemnn_txy = np.load('evaluation_vector_error/Bemnn_txy_'+str(key)+'.npy') # 2-norm of [Bemnn_tx, Bemnn_ty] for scalar error
Bemnn_t   = np.load('evaluation_vector_error/Bemnn_t_'+str(key)+'.npy') # 2-norm of [Bemnn_tx, Bemnn_ty, Bemnn_tz] for scalar error
#---load the NeuroBEM residual data of f_xy, f, tau_xy, and tau (vector error)---#
E_BEM_fxy = np.load('evaluation_vector_error/error_fxy_bem_v_'+str(key)+'.npy')
E_BEM_f   = np.load('evaluation_vector_error/error_f_bem_v_'+str(key)+'.npy')
E_BEM_txy = np.load('evaluation_vector_error/error_txy_bem_v_'+str(key)+'.npy')
E_BEM_t   = np.load('evaluation_vector_error/error_t_bem_v_'+str(key)+'.npy')

#---load the NeuroMHE prediction data---#
# the same model used in T-RO 23-0314 v1
fx_mhe  = np.load('evaluation_vector_error/fx_mhe_'+str(key)+'.npy') 
fy_mhe  = np.load('evaluation_vector_error/fy_mhe_'+str(key)+'.npy')
fz_mhe  = np.load('evaluation_vector_error/fz_mhe_'+str(key)+'.npy')
tx_mhe  = np.load('evaluation_vector_error/tx_mhe_'+str(key)+'.npy')
ty_mhe  = np.load('evaluation_vector_error/ty_mhe_'+str(key)+'.npy')
tz_mhe  = np.load('evaluation_vector_error/tz_mhe_'+str(key)+'.npy')
fxy_mhe = np.load('evaluation_vector_error/fxy_mhe_'+str(key)+'.npy') # 2-norm of [fx_mhe, fy_mhe] for scalar error
f_mhe   = np.load('evaluation_vector_error/f_mhe_'+str(key)+'.npy') # 2-norm of [fx_mhe, fy_mhe, fz_mhe] for scalar error
txy_mhe = np.load('evaluation_vector_error/txy_mhe_'+str(key)+'.npy') # 2-norm of [tx_mhe, ty_mhe] for scalar error
t_mhe   = np.load('evaluation_vector_error/t_mhe_'+str(key)+'.npy') # 2-norm of [tx_mhe, ty_mhe, tz_mhe] for scalar error
#---load the NeuroMHE residual data of f_xy, f, tau_xy, and tau (vector error)---#
E_MHE_fxy = np.load('evaluation_vector_error/error_fxy_mhe_v_'+str(key)+'.npy')
E_MHE_f   = np.load('evaluation_vector_error/error_f_mhe_v_'+str(key)+'.npy')
E_MHE_txy = np.load('evaluation_vector_error/error_txy_mhe_v_'+str(key)+'.npy')
E_MHE_t   = np.load('evaluation_vector_error/error_t_mhe_v_'+str(key)+'.npy')
