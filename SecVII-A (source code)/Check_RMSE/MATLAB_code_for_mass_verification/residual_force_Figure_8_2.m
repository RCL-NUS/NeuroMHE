...
clear
load('bemnn20210223104803seg2.mat')
...
[r,c]            = size(bemnn20210223104803seg2);
resi_f           = zeros(r,3);
...
for i=1:1:r
    acc_p                 = bemnn20210223104803seg2(i,12:14).';
    acc_w                 = bemnn20210223104803seg2(i,2:4).';
    w                     = bemnn20210223104803seg2(i,5:7).';
    [f,tau]               = ground_truth(w,acc_p,acc_w,m,J);
    [f_updated,tau]       = ground_truth(w,acc_p,acc_w,m_updated,J);
    f_bemnn               = bemnn20210223104803seg2(i,30:32);
    resi_f(i,:)           = f.'- f_bemnn;
    resi_f_updated(i,:)   = f_updated.' - f_bemnn;
    resi_f_bemnn          = bemnn20210223104803seg2(i,36:38);
