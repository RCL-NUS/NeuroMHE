...
Gt_fx = np.load('evaluation_slow_better_cond_B/Gt_fx_'+str(key)+'.npy')
Gt_fy = np.load('evaluation_slow_better_cond_B/Gt_fy_'+str(key)+'.npy')
Gt_fz = np.load('evaluation_slow_better_cond_B/Gt_fz_'+str(key)+'.npy')
Gt_tx = np.load('evaluation_slow_better_cond_B/Gt_tx_'+str(key)+'.npy')
Gt_ty = np.load('evaluation_slow_better_cond_B/Gt_ty_'+str(key)+'.npy')
Gt_tz = np.load('evaluation_slow_better_cond_B/Gt_tz_'+str(key)+'.npy')
Gt_fxy = np.load('evaluation_slow_better_cond_B/Gt_fxy_'+str(key)+'.npy') # 2-norm of [Gt_fx, Gt_fy] for scalar error
Gt_f   = np.load('evaluation_slow_better_cond_B/Gt_f_'+str(key)+'.npy') # 2-norm of [Gt_fx, Gt_fy, Gt_fz] for scalar error
Gt_txy = np.load('evaluation_slow_better_cond_B/Gt_txy_'+str(key)+'.npy') # 2-norm of [Gt_tx, Gt_ty] for scalar error
Gt_t   = np.load('evaluation_slow_better_cond_B/Gt_t_'+str(key)+'.npy') # 2-norm of [Gt_tx, Gt_ty, Gt_tz] for scalar error

#---load the NeuroBEM prediction data (copied from the open-source dataset)---#
Bemnn_fx  = np.load('evaluation_slow_better_cond_B/Bemnn_fx_'+str(key)+'.npy')
Bemnn_fy  = np.load('evaluation_slow_better_cond_B/Bemnn_fy_'+str(key)+'.npy')
Bemnn_fz  = np.load('evaluation_slow_better_cond_B/Bemnn_fz_'+str(key)+'.npy')
Bemnn_tx  = np.load('evaluation_slow_better_cond_B/Bemnn_tx_'+str(key)+'.npy')
Bemnn_ty  = np.load('evaluation_slow_better_cond_B/Bemnn_ty_'+str(key)+'.npy')
Bemnn_tz  = np.load('evaluation_slow_better_cond_B/Bemnn_tz_'+str(key)+'.npy')
Bemnn_fxy = np.load('evaluation_slow_better_cond_B/Bemnn_fxy_'+str(key)+'.npy') # 2-norm of [Bemnn_fx, Bemnn_fy] for scalar error
Bemnn_f   = np.load('evaluation_slow_better_cond_B/Bemnn_f_'+str(key)+'.npy') # 2-norm of [Bemnn_fx, Bemnn_fy, Bemnn_fz] for scalar error
Bemnn_txy = np.load('evaluation_slow_better_cond_B/Bemnn_txy_'+str(key)+'.npy') # 2-norm of [Bemnn_tx, Bemnn_ty] for scalar error
Bemnn_t   = np.load('evaluation_slow_better_cond_B/Bemnn_t_'+str(key)+'.npy') # 2-norm of [Bemnn_tx, Bemnn_ty, Bemnn_tz] for scalar error
#---load the NeuroBEM residual data of f_xy, f, tau_xy, and tau (vector error)---#
E_BEM_fxy = np.load('evaluation_slow_better_cond_B/error_fxy_bem_v_'+str(key)+'.npy')
E_BEM_f   = np.load('evaluation_slow_better_cond_B/error_f_bem_v_'+str(key)+'.npy')
E_BEM_txy = np.load('evaluation_slow_better_cond_B/error_txy_bem_v_'+str(key)+'.npy')
E_BEM_t   = np.load('evaluation_slow_better_cond_B/error_t_bem_v_'+str(key)+'.npy')
...
fx_mhe  = np.load('evaluation_slow_better_cond_B/fx_mhe_'+str(key)+'.npy') 
fy_mhe  = np.load('evaluation_slow_better_cond_B/fy_mhe_'+str(key)+'.npy')
fz_mhe  = np.load('evaluation_slow_better_cond_B/fz_mhe_'+str(key)+'.npy')
tx_mhe  = np.load('evaluation_slow_better_cond_B/tx_mhe_'+str(key)+'.npy')
ty_mhe  = np.load('evaluation_slow_better_cond_B/ty_mhe_'+str(key)+'.npy')
tz_mhe  = np.load('evaluation_slow_better_cond_B/tz_mhe_'+str(key)+'.npy')
fxy_mhe = np.load('evaluation_slow_better_cond_B/fxy_mhe_'+str(key)+'.npy') # 2-norm of [fx_mhe, fy_mhe] for scalar error
f_mhe   = np.load('evaluation_slow_better_cond_B/f_mhe_'+str(key)+'.npy') # 2-norm of [fx_mhe, fy_mhe, fz_mhe] for scalar error
txy_mhe = np.load('evaluation_slow_better_cond_B/txy_mhe_'+str(key)+'.npy') # 2-norm of [tx_mhe, ty_mhe] for scalar error
t_mhe   = np.load('evaluation_slow_better_cond_B/t_mhe_'+str(key)+'.npy') # 2-norm of [tx_mhe, ty_mhe, tz_mhe] for scalar error
#---load the NeuroMHE residual data of f_xy, f, tau_xy, and tau (vector error)---#
E_MHE_fxy = np.load('evaluation_slow_better_cond_B/error_fxy_mhe_v_'+str(key)+'.npy')
E_MHE_f   = np.load('evaluation_slow_better_cond_B/error_f_mhe_v_'+str(key)+'.npy')
E_MHE_txy = np.load('evaluation_slow_better_cond_B/error_txy_mhe_v_'+str(key)+'.npy')
E_MHE_t   = np.load('evaluation_slow_better_cond_B/error_t_mhe_v_'+str(key)+'.npy')
