...
Gt_fx = np.load('evaluation_vector_error_slowtrainingset/Gt_fx_'+str(key)+'.npy')
Gt_fy = np.load('evaluation_vector_error_slowtrainingset/Gt_fy_'+str(key)+'.npy')
Gt_fz = np.load('evaluation_vector_error_slowtrainingset/Gt_fz_'+str(key)+'.npy')
Gt_tx = np.load('evaluation_vector_error_slowtrainingset/Gt_tx_'+str(key)+'.npy')
Gt_ty = np.load('evaluation_vector_error_slowtrainingset/Gt_ty_'+str(key)+'.npy')
Gt_tz = np.load('evaluation_vector_error_slowtrainingset/Gt_tz_'+str(key)+'.npy')
Gt_fxy = np.load('evaluation_vector_error_slowtrainingset/Gt_fxy_'+str(key)+'.npy') # 2-norm of [Gt_fx, Gt_fy] for scalar error
Gt_f   = np.load('evaluation_vector_error_slowtrainingset/Gt_f_'+str(key)+'.npy') # 2-norm of [Gt_fx, Gt_fy, Gt_fz] for scalar error
Gt_txy = np.load('evaluation_vector_error_slowtrainingset/Gt_txy_'+str(key)+'.npy') # 2-norm of [Gt_tx, Gt_ty] for scalar error
Gt_t   = np.load('evaluation_vector_error_slowtrainingset/Gt_t_'+str(key)+'.npy') # 2-norm of [Gt_tx, Gt_ty, Gt_tz] for scalar error

#---load the NeuroBEM prediction data (copied from the open-source dataset)---#
Bemnn_fx  = np.load('evaluation_vector_error_slowtrainingset/Bemnn_fx_'+str(key)+'.npy')
Bemnn_fy  = np.load('evaluation_vector_error_slowtrainingset/Bemnn_fy_'+str(key)+'.npy')
Bemnn_fz  = np.load('evaluation_vector_error_slowtrainingset/Bemnn_fz_'+str(key)+'.npy')
Bemnn_tx  = np.load('evaluation_vector_error_slowtrainingset/Bemnn_tx_'+str(key)+'.npy')
Bemnn_ty  = np.load('evaluation_vector_error_slowtrainingset/Bemnn_ty_'+str(key)+'.npy')
Bemnn_tz  = np.load('evaluation_vector_error_slowtrainingset/Bemnn_tz_'+str(key)+'.npy')
Bemnn_fxy = np.load('evaluation_vector_error_slowtrainingset/Bemnn_fxy_'+str(key)+'.npy') # 2-norm of [Bemnn_fx, Bemnn_fy] for scalar error
Bemnn_f   = np.load('evaluation_vector_error_slowtrainingset/Bemnn_f_'+str(key)+'.npy') # 2-norm of [Bemnn_fx, Bemnn_fy, Bemnn_fz] for scalar error
Bemnn_txy = np.load('evaluation_vector_error_slowtrainingset/Bemnn_txy_'+str(key)+'.npy') # 2-norm of [Bemnn_tx, Bemnn_ty] for scalar error
Bemnn_t   = np.load('evaluation_vector_error_slowtrainingset/Bemnn_t_'+str(key)+'.npy') # 2-norm of [Bemnn_tx, Bemnn_ty, Bemnn_tz] for scalar error
#---load the NeuroBEM residual data of f_xy, f, tau_xy, and tau (vector error)---#
E_BEM_fxy = np.load('evaluation_vector_error_slowtrainingset/error_fxy_bem_v_'+str(key)+'.npy')
E_BEM_f   = np.load('evaluation_vector_error_slowtrainingset/error_f_bem_v_'+str(key)+'.npy')
E_BEM_txy = np.load('evaluation_vector_error_slowtrainingset/error_txy_bem_v_'+str(key)+'.npy')
E_BEM_t   = np.load('evaluation_vector_error_slowtrainingset/error_t_bem_v_'+str(key)+'.npy')
...
fx_mhe  = np.load('evaluation_vector_error_slowtrainingset/fx_mhe_'+str(key)+'.npy') 
fy_mhe  = np.load('evaluation_vector_error_slowtrainingset/fy_mhe_'+str(key)+'.npy')
fz_mhe  = np.load('evaluation_vector_error_slowtrainingset/fz_mhe_'+str(key)+'.npy')
tx_mhe  = np.load('evaluation_vector_error_slowtrainingset/tx_mhe_'+str(key)+'.npy')
ty_mhe  = np.load('evaluation_vector_error_slowtrainingset/ty_mhe_'+str(key)+'.npy')
tz_mhe  = np.load('evaluation_vector_error_slowtrainingset/tz_mhe_'+str(key)+'.npy')
fxy_mhe = np.load('evaluation_vector_error_slowtrainingset/fxy_mhe_'+str(key)+'.npy') # 2-norm of [fx_mhe, fy_mhe] for scalar error
f_mhe   = np.load('evaluation_vector_error_slowtrainingset/f_mhe_'+str(key)+'.npy') # 2-norm of [fx_mhe, fy_mhe, fz_mhe] for scalar error
txy_mhe = np.load('evaluation_vector_error_slowtrainingset/txy_mhe_'+str(key)+'.npy') # 2-norm of [tx_mhe, ty_mhe] for scalar error
t_mhe   = np.load('evaluation_vector_error_slowtrainingset/t_mhe_'+str(key)+'.npy') # 2-norm of [tx_mhe, ty_mhe, tz_mhe] for scalar error
#---load the NeuroMHE residual data of f_xy, f, tau_xy, and tau (vector error)---#
E_MHE_fxy = np.load('evaluation_vector_error_slowtrainingset/error_fxy_mhe_v_'+str(key)+'.npy')
E_MHE_f   = np.load('evaluation_vector_error_slowtrainingset/error_f_mhe_v_'+str(key)+'.npy')
E_MHE_txy = np.load('evaluation_vector_error_slowtrainingset/error_txy_mhe_v_'+str(key)+'.npy')
E_MHE_t   = np.load('evaluation_vector_error_slowtrainingset/error_t_mhe_v_'+str(key)+'.npy')
