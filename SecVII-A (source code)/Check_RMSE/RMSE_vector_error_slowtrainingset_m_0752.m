...
filename=['evaluation_vector_error_slowtrainingset_m=0752/disest_mhe_',key,'.csv'];
disest_mhe = readmatrix(filename);
%---load the NeuroBEM prediction data---%
if key=='a'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210218134423seg2.mat'); % the .mat file is imported from the corresponding .csv file from the open-sourced dataset
elseif key=='b'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210218165335seg2.mat');
elseif key=='c'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210218170320seg2.mat');
elseif key=='d'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210218171908seg2.mat');
elseif key=='e'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210218172600seg1.mat');
elseif key=='f'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210218180845seg1.mat');
elseif key=='g'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210223104803seg2.mat');
elseif key=='h'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210223114138seg3.mat');
elseif key=='i'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210223142148seg3.mat');
elseif key=='j'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210223172724seg2.mat');
elseif key=='k'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210223194506seg2.mat');
elseif key=='l'
    bemnn = importdata('MATLAB code for mass verification/bemnn20210223222625seg2.mat');
else
    bemnn = importdata('MATLAB code for mass verification/bemnn20210223225417seg1.mat');
end

%------------------------------------------------------------------------%
%RMSE Computation (Metrics: f in body frame, vector-error formula, m=0.752kg)
%------------------------------------------------------------------------%

m_updated        = 0.752; %initially reported mass value in the NeuroBEM paper
...
disp('------------------------------RMSEs with scalar error (body frame and m=0.752kg)--------------------------------')
disp('----------------------------------------------------------------------------------------------------------------')
