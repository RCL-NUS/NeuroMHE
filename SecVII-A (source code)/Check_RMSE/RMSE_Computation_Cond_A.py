...
Gt_fx = np.load('evaluation_cond_A/Gt_fx_'+str(key)+'.npy')
Gt_fy = np.load('evaluation_cond_A/Gt_fy_'+str(key)+'.npy')
Gt_fz = np.load('evaluation_cond_A/Gt_fz_'+str(key)+'.npy')
Gt_tx = np.load('evaluation_cond_A/Gt_tx_'+str(key)+'.npy')
Gt_ty = np.load('evaluation_cond_A/Gt_ty_'+str(key)+'.npy')
Gt_tz = np.load('evaluation_cond_A/Gt_tz_'+str(key)+'.npy')
Gt_fxy = np.load('evaluation_cond_A/Gt_fxy_'+str(key)+'.npy') # 2-norm of [Gt_fx, Gt_fy] for scalar error
Gt_f   = np.load('evaluation_cond_A/Gt_f_'+str(key)+'.npy') # 2-norm of [Gt_fx, Gt_fy, Gt_fz] for scalar error
Gt_txy = np.load('evaluation_cond_A/Gt_txy_'+str(key)+'.npy') # 2-norm of [Gt_tx, Gt_ty] for scalar error
Gt_t   = np.load('evaluation_cond_A/Gt_t_'+str(key)+'.npy') # 2-norm of [Gt_tx, Gt_ty, Gt_tz] for scalar error

#---load the NeuroBEM prediction data (copied from the open-source dataset)---#
Bemnn_fx  = np.load('evaluation_cond_A/Bemnn_fx_'+str(key)+'.npy')
Bemnn_fy  = np.load('evaluation_cond_A/Bemnn_fy_'+str(key)+'.npy')
Bemnn_fz  = np.load('evaluation_cond_A/Bemnn_fz_'+str(key)+'.npy')
Bemnn_tx  = np.load('evaluation_cond_A/Bemnn_tx_'+str(key)+'.npy')
Bemnn_ty  = np.load('evaluation_cond_A/Bemnn_ty_'+str(key)+'.npy')
Bemnn_tz  = np.load('evaluation_cond_A/Bemnn_tz_'+str(key)+'.npy')
Bemnn_fxy = np.load('evaluation_cond_A/Bemnn_fxy_'+str(key)+'.npy') # 2-norm of [Bemnn_fx, Bemnn_fy] for scalar error
Bemnn_f   = np.load('evaluation_cond_A/Bemnn_f_'+str(key)+'.npy') # 2-norm of [Bemnn_fx, Bemnn_fy, Bemnn_fz] for scalar error
Bemnn_txy = np.load('evaluation_cond_A/Bemnn_txy_'+str(key)+'.npy') # 2-norm of [Bemnn_tx, Bemnn_ty] for scalar error
Bemnn_t   = np.load('evaluation_cond_A/Bemnn_t_'+str(key)+'.npy') # 2-norm of [Bemnn_tx, Bemnn_ty, Bemnn_tz] for scalar error

#---load the NeuroMHE prediction data---#
# the same model used in T-RO 23-0314 v1
fx_mhe  = np.load('evaluation_cond_A/fx_mhe_'+str(key)+'.npy') 
fy_mhe  = np.load('evaluation_cond_A/fy_mhe_'+str(key)+'.npy')
fz_mhe  = np.load('evaluation_cond_A/fz_mhe_'+str(key)+'.npy')
tx_mhe  = np.load('evaluation_cond_A/tx_mhe_'+str(key)+'.npy')
ty_mhe  = np.load('evaluation_cond_A/ty_mhe_'+str(key)+'.npy')
tz_mhe  = np.load('evaluation_cond_A/tz_mhe_'+str(key)+'.npy')
fxy_mhe = np.load('evaluation_cond_A/fxy_mhe_'+str(key)+'.npy') # 2-norm of [fx_mhe, fy_mhe] for scalar error
f_mhe   = np.load('evaluation_cond_A/f_mhe_'+str(key)+'.npy') # 2-norm of [fx_mhe, fy_mhe, fz_mhe] for scalar error
txy_mhe = np.load('evaluation_cond_A/txy_mhe_'+str(key)+'.npy') # 2-norm of [tx_mhe, ty_mhe] for scalar error
t_mhe   = np.load('evaluation_cond_A/t_mhe_'+str(key)+'.npy') # 2-norm of [tx_mhe, ty_mhe, tz_mhe] for scalar error
