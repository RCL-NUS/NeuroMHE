...
class MHE:
    ...
    def diffKKT_general(self):
        ...
        self.ddL0xp_fn    = Function('ddL0xw', [self.state, self.costate, self.noise, self.measurement, self.weight_para, self.horizon1, self.index], [self.ddL0xp], ['x0', 'c0', 'n0', 'm0', 'tp', 'h1', 'ind'], ['ddL0xpf'])
