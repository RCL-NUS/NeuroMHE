...
Bemnn_fxy = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Bemnn_fxy_j.npy')
Bemnn_fz  = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Bemnn_fz_j.npy')
Bemnn_txy = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Bemnn_txy_j.npy')
Bemnn_tz  = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Bemnn_tz_j.npy')
Bemnn_f   = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Bemnn_f_j.npy')
Bemnn_t   = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Bemnn_t_j.npy')
# Ground truth data 
Gt_fxy    = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Gt_fxy_j.npy')
Gt_fz     = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Gt_fz_j.npy')
Gt_txy    = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Gt_txy_j.npy')
Gt_tz     = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Gt_tz_j.npy')
Gt_f      = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Gt_f_j.npy')
Gt_t      = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Gt_t_j.npy')
# NeuroMHE data
fxy_mhe   = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/fxy_mhe_j.npy')
fz_mhe    = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/fz_mhe_j.npy')
txy_mhe   = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/txy_mhe_j.npy')
tz_mhe    = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/tz_mhe_j.npy')
f_mhe     = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/f_mhe_j.npy')
t_mhe     = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/t_mhe_j.npy')
# Time
time      = np.load('Check_RMSE/evaluation_vector_error_slowtrainingset/Time_j.npy')
"""------------Plot figures---------------"""
font1 = {'family':'arial',
         'weight':'normal',
         'style':'normal', 'size':6}
