...
Bemnn_fxy = np.load('Check_RMSE/evaluation_slow_better_cond_B/Bemnn_fxy_j.npy')
Bemnn_fz  = np.load('Check_RMSE/evaluation_slow_better_cond_B/Bemnn_fz_j.npy')
Bemnn_txy = np.load('Check_RMSE/evaluation_slow_better_cond_B/Bemnn_txy_j.npy')
Bemnn_tz  = np.load('Check_RMSE/evaluation_slow_better_cond_B/Bemnn_tz_j.npy')
Bemnn_f   = np.load('Check_RMSE/evaluation_slow_better_cond_B/Bemnn_f_j.npy')
Bemnn_t   = np.load('Check_RMSE/evaluation_slow_better_cond_B/Bemnn_t_j.npy')
# Ground truth data 
Gt_fxy    = np.load('Check_RMSE/evaluation_slow_better_cond_B/Gt_fxy_j.npy')
Gt_fz     = np.load('Check_RMSE/evaluation_slow_better_cond_B/Gt_fz_j.npy')
Gt_txy    = np.load('Check_RMSE/evaluation_slow_better_cond_B/Gt_txy_j.npy')
Gt_tz     = np.load('Check_RMSE/evaluation_slow_better_cond_B/Gt_tz_j.npy')
Gt_f      = np.load('Check_RMSE/evaluation_slow_better_cond_B/Gt_f_j.npy')
Gt_t      = np.load('Check_RMSE/evaluation_slow_better_cond_B/Gt_t_j.npy')
# NeuroMHE data
fxy_mhe   = np.load('Check_RMSE/evaluation_slow_better_cond_B/fxy_mhe_j.npy')
fz_mhe    = np.load('Check_RMSE/evaluation_slow_better_cond_B/fz_mhe_j.npy')
txy_mhe   = np.load('Check_RMSE/evaluation_slow_better_cond_B/txy_mhe_j.npy')
tz_mhe    = np.load('Check_RMSE/evaluation_slow_better_cond_B/tz_mhe_j.npy')
f_mhe     = np.load('Check_RMSE/evaluation_slow_better_cond_B/f_mhe_j.npy')
t_mhe     = np.load('Check_RMSE/evaluation_slow_better_cond_B/t_mhe_j.npy')
# Time
time      = np.load('evaluation_slow_better_cond_B/Time_j.npy')
"""------------Plot figures---------------"""
font1 = {'family':'arial',
         'weight':'normal',
         'style':'normal', 'size':6}
...
fig=plt.figure(1, figsize=(8/cm_2_inch,5*0.7/cm_2_inch), dpi=600)
...
plt1.legend(loc='upper center',prop=font2, bbox_to_anchor=(0.7, 1.17),labelspacing=0.15,ncol = 3,columnspacing=0.5,borderpad=0.3,handletextpad=0.4,handlelength=1.5) #mode = "expand",ncol = 3
...
for t in plt2.yaxis.get_major_ticks(): 
    t.label.set_font('arial') 
    t.label.set_fontsize(5)
plt.savefig('plots_in_paper/force_xy.png',bbox_inches="tight", pad_inches=0)
plt.show()

fig=plt.figure(2, figsize=(8/cm_2_inch,5*0.7/cm_2_inch), dpi=600)
...
plt1.add_patch(Rectangle((-0.25,6.75), 1.25, 1.25,alpha=1, fill=None, facecolor='none',linewidth=0.3,linestyle='--',zorder=5))
plt1.add_patch(Rectangle((8.6, 27), 6.4, 9,alpha=1, fill=None, facecolor='none',linewidth=0.3,linestyle='--',zorder=5))
plt1.set_xlabel('Time [s]', labelpad=0,**font1)
plt1.set_xticks(np.arange(0,25,8))
plt1.set_xlim(-1,25)
...
for axis in ['bottom', 'left', 'right']:
    plt1.spines[axis].set_linewidth(0.5)
for axis in ['top']:
    plt1.spines[axis].set_linewidth(0.75)
for t in plt1.xaxis.get_major_ticks(): 
    t.label.set_font('arial') 
    t.label.set_fontsize(6)
for t in plt1.yaxis.get_major_ticks(): 
...
plt1.arrow(15,34,10.5,0,fc="k", ec="k",head_width=0.6,zorder=1, head_length=1,clip_on =False,linewidth=0.35)
...
plt2.set_ylim(27,35.5)
plt2.set_yticks(np.arange(29,35.5,3))
plt2.grid(b=True,axis='both',linestyle='--', linewidth=0.5)
plt2.tick_params(axis='x',which='major',pad=0, length=0.5)
plt2.tick_params(axis='y',which='major',pad=0, length=0.5)
for axis in ['bottom', 'left', 'right']:
    plt2.spines[axis].set_linewidth(0.5)
for axis in ['top']:
    plt2.spines[axis].set_linewidth(0.75)
for t in plt2.xaxis.get_major_ticks(): 
    t.label.set_font('arial') 
    t.label.set_fontsize(5)
for t in plt2.yaxis.get_major_ticks(): 
...
for t in plt3.yaxis.get_major_ticks(): 
    t.label.set_font('arial') 
    t.label.set_fontsize(5)
plt.savefig('plots_in_paper/force_z.png',bbox_inches="tight", pad_inches=0)
plt.show()


plt.figure(3, figsize=(8/cm_2_inch,5*0.7/cm_2_inch), dpi=600)
plt1 = plt.subplot2grid((1, 3), (0, 0), colspan=2)
plt2 = plt.subplot2grid((1, 3), (0, 2), colspan=1)
...
plt.savefig('plots_in_paper/torque_xy.png',bbox_inches="tight", pad_inches=0)
plt.show()


plt.figure(4, figsize=(8/cm_2_inch,5*0.7/cm_2_inch), dpi=600)
plt1 = plt.subplot2grid((1, 3), (0, 0), colspan=2)
plt2 = plt.subplot2grid((1, 3), (0, 2), colspan=1)
...
plt.savefig('plots_in_paper/torque_z.png',bbox_inches="tight", pad_inches=0)
plt.show()
